...
public class TestMain {
    ...
    public static void main(String[] args) {
        ...
        SmsMessageRepository messagerep = new SmsMessageRepository(ip,port,user,password);
        ...
        list.forEach(message -> System.out.println(message.toString()));
    ...
    public static void testSave(SmsMessageRepository messagerep, String suffix) {
        ...
        for (int j = 0; j < 100; j++) {
            // 模拟
            String enj = "00000" + j;
            String smsId = suffix + "123456789" + enj.substring(enj.length() - 3);
            SmsMessage sms = new SmsMessage();
            sms.setAppCode("852");
            ...
            EsInsertItem<SmsMessage> mes = new EsInsertItem<>(sms.getId(), sms);
            list.add(mes);
        }
